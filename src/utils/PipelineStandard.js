...
function PipelineStandard() {
    ...
    var getStandardLineColor = function (type) {
        switch (type) {
            ...
            default:
                return GetStandardLineColorEx(Math.floor(type / 1000) * 1000);
        }
    };
    //为交大项目横切面的点颜色专属方法 
    ...
    this.PipelineLayoutType = PipelineLayoutType;
    this.getFieldsByType = getFieldsByType;
    this.getCoverageStandard = getCoverageStandard;
    this.getVerticalSpacingStandard = getVerticalSpacingStandard;
    this.getHorizontalSpacingStandard = getHorizontalSpacingStandard;
    this.getStandardLineColor = getStandardLineColor;
    this.standardColor = standardColor;
    this.getMaterialColorForjiaoda = getMaterialColorForjiaoda;
}
export default PipelineStandard
