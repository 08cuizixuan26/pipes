...
export default {
    createElement: function(self, elmentArr, options){
        ...
        var obj = Mark.createElementDynamicWall(earth, window.g_VideoLayer, options);
        if(obj){
            elmentArr.push(obj);
        }
    },
    create: function(self){
        ...
        Mark.createPolyline(earth, function(retData){
            ...
            var dataConf = deepCopy(drawConfig["wall"]);
    ...
    edit: function(self, data){
        ...
        self.$refs.objectDialog.show({
            ...
            callbackOK: function(){
                ...
                var obj = Mark.editElementDynamicWall(self.elementArr[selIndex], options, earth, window.g_VideoLayer);
                if(obj){//保存对象到全局
