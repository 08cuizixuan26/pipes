...
export default {
    createElement: function(self, elmentArr, options){
        ...
        var obj = Mark.createElementDynamicScan(earth, window.g_VideoLayer, options);
        if(obj){
            elmentArr.push(obj);
        }
    },
    create: function(self){
        ...
        Mark.createCircle(earth, function(retData){
            ...
            var dataConf = deepCopy(drawConfig["scan"]);
    ...
    edit: function(self, data){
        ...
        self.$refs.objectDialog.show({
            ...
            callbackOK: function(){
                ...
                var obj = Mark.editElementDynamicScan(self.elementArr[selIndex], options, earth, window.g_VideoLayer);
                if(obj){//保存对象到全局
