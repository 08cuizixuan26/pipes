...
export default {
    createElement: function(self, elmentArr, options){
        ...
        var obj = Mark.createElementLinebuffer(earth, options);
        if(obj){
            elmentArr.push(obj);
        }
    },
    create: function(self){
        ...
        Mark.createPolyline(earth, function(retData){
            ...
            var dataConf = deepCopy(drawConfig["linebuffer"]);
    ...
    edit: function(self, data){
        ...
        self.$refs.objectDialog.show({
            ...
            callbackOK: function(){
                ...
                var obj = Mark.editElementLinebuffer(earth,self.elementArr[selIndex], options);
                if(obj){//保存对象到全局
