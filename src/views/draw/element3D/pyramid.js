...
export default {
    createElement: function(self, elmentArr, options){
        ...
        var obj = Mark.createElementPyramid(earth, options);
        if(obj){
            elmentArr.push(obj);
        }
    },
    create: function(self){
        var that = this;
        var earth = self.stampAPI.usearth;
        Mark.createPyramid(earth, function(retData){
            ...
            var dataConf = deepCopy(drawConfig["pyramid"]);
            dataConf.height.value = retData.height;
            dataConf.radiusBottom.value = retData.radiusBottom;
            dataConf.radiusTop.value = retData.radiusTop;
            ...
            self.$refs.objectDialog.show({
                ...
                callbackOK: function(){
                    ...
                    options.radiusBottom = retData.radiusBottom;
                    options.radiusTop = retData.radiusTop;
    ...
    edit: function(self, data){
        ...
        self.$refs.objectDialog.show({
            ...
            callbackOK: function(){
                ...
                options.radiusBottom = data.radiusBottom;
                options.radiusTop = data.radiusTop;
                ...
                var obj = Mark.editElementPyramid(self.elementArr[selIndex],options);
                if(obj){//保存对象到全局
