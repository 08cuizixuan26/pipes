...
export default {
  createElement(self, elmentArr, options) {
    ...
    var obj = Mark.createEleMoveSolLine(earth, window.g_VideoLayer, options);
    if (obj) {
      elmentArr.push(obj);
    }
  },
    ...
    Mark.createLine(earth, function(retData) {
      ...
      self.$refs.objectDialog.show({
        ...
        callbackOK: function() {
          ...
          var obj = Mark.createEleMoveSolLine(
            earth,
            window.g_VideoLayer,
            options
          );
