...
export default {
    createElement: function(self, elmentArr, options){
        ...
        var obj = Mark.createElementODLine(earth, window.g_VideoLayer, options);
        if(obj){
            elmentArr.push(obj);
        }
    },
    create: function(self){
        ...
        Mark.createLine(earth, function(retData){
            ...
            var dataConf = deepCopy(drawConfig["odLine"]);
    ...
    createElementObj: function(self, options, lineObj, parentInfo){
        var earth = self.stampAPI.usearth;
        var obj = Mark.createElementODLine(earth, window.g_VideoLayer, options, lineObj);
        if(obj){
    ...
    edit: function(self, data){
        ...
        self.$refs.objectDialog.show({
            ...
            callbackOK: function(){
                ...
                var obj = Mark.editElementODLine(self.elementArr[selIndex], options);
                if(obj){//保存对象到全局
