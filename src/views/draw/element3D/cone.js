...
export default {
    createElement: function(self, elmentArr, options){
        ...
        var obj = Mark.createElementCone(earth, options);
        if(obj){
            elmentArr.push(obj);
        }
    },
    create: function(self){
        var that = this;
        var earth = self.stampAPI.usearth;
        Mark.createCone(earth, function(retData){
            ...
            var dataConf = deepCopy(drawConfig["cone"]);
    ...
    edit: function(self, data){
        ...
        self.$refs.objectDialog.show({
            ...
            callbackOK: function(){
                ...
                var obj = Mark.editElementCone(self.elementArr[selIndex],options);
                if(obj){//保存对象到全局
