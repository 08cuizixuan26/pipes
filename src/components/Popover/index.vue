<template>
  ...
  >
    ...
    >
      ...
      >
        <div :class="['el-dialog__headerDiv', { backPaddingClass2: isBack }]">
          <slot name="title">
            <span
              :class="['el-dialog__title', { backPaddingClass3: isBack }]"
              >{{ title }}</span
            >
          </slot>
          <div
...
.el-dialog__body {
  ...
  text-align: center;
  font-size: 14px;
  background: url(../../../public/images/popover/second_bg_body.png) repeat-y;
...
.el-dialog__header {
  ...
  // min-height: 1.5vw;
  // height: 35px;
  background: url(../../../public/images/popover/second_bg_head.png) no-repeat;
...
.footer {
  // margin-top: 0px;
  background: url(../../../public/images/popover/second_bg_foot.png) no-repeat;
  background-size: 100% 100%;
  min-height: 40px;
  max-height: 60px;
}
